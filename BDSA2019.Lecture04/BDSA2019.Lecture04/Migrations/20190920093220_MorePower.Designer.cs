...
namespace BDSA2019.Lecture04.Migrations
{
    ...
    [Migration("20190920093220_MorePower")]
    partial class MorePower
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BDSA2019.Lecture04.Power", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BDSA2019.Lecture04.SuperheroPower", b =>
                {
            ...
            modelBuilder.Entity("BDSA2019.Lecture04.SuperheroPower", b =>
                {
                    b.HasOne("BDSA2019.Lecture04.Power", "Power")
                        .WithMany("Superheroes")
                        .HasForeignKey("PowerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BDSA2019.Lecture04.Superhero", "Superhero")
                        .WithMany("Powers")
