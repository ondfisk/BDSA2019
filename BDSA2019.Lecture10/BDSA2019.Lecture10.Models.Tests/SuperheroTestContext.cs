...
using static BDSA2019.Lecture10.Entities.Gender;

namespace BDSA2019.Lecture10.Models.Tests
{
    public class SuperheroTestContext : SuperheroContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Superhero>()
                        ...
                        .HasConversion(
                            v => v.ToString(),
                            v => (Entities.Gender)Enum.Parse(typeof(Entities.Gender), v));
            ...
            string portraitUrl(string name) => $"https://ondfisk.blob.core.windows.net/superheroes/{name}-portrait.jpg";
            string backgroundUrl(string name) => $"https://ondfisk.blob.core.windows.net/superheroes/{name}-background.jpg";

            modelBuilder.Entity<Superhero>().HasData(
                new Superhero { Id = 1, Name = "Clark Kent", AlterEgo = "Superman", Occupation = "Reporter", Gender = Male, FirstAppearance = 1938, CityId = 1, PortraitUrl = portraitUrl("superman"), BackgroundUrl = backgroundUrl("superman") },
                new Superhero { Id = 2, Name = "Bruce Wayne", AlterEgo = "Batman", Occupation = "CEO of Wayne Enterprises", Gender = Male, FirstAppearance = 1939, CityId = 2, PortraitUrl = portraitUrl("batman"), BackgroundUrl = backgroundUrl("batman") },
                new Superhero { Id = 3, Name = "Selina Kyle", AlterEgo = "Catwoman", Occupation = "Thief", Gender = Female, FirstAppearance = 1940, CityId = 2, PortraitUrl = portraitUrl("catwoman"), BackgroundUrl = backgroundUrl("catwoman") }
            );
